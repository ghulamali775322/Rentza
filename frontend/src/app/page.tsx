              ...
              return (
                <li key={mainCat.name} className="border-b border-gray-50 last:border-0">
                  <div className="flex justify-between items-center px-3 py-3 hover:bg-gray-50 rounded-md transition-colors">
                    ...
                    >
                      <FiChevronDown className={`transition-transform duration-200 ${isExpanded ? "rotate-180" : ""}`} size={18} />
                    </button>
                  </div>
      ...
      <section className="px-4 md:px-10 py-12 bg-gray-50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-2xl shadow-md hover:shadow-xl border border-gray-100 hover:border-blue-500 hover:-translate-y-2 hover:bg-blue-50 transition-all duration-300">
            <h3 className="text-lg font-semibold text-blue-700 mb-3 text-center">For Renters</h3>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-md hover:shadow-xl border border-gray-100 hover:border-blue-500 hover:-translate-y-2 hover:bg-blue-50 transition-all duration-300">
            <h3 className="text-lg font-semibold text-blue-700 mb-3 text-center">For Lenders</h3>
            <ul className="text-gray-700 text-sm space-y-2">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-md hover:shadow-xl border border-gray-100 hover:border-blue-500 hover:-translate-y-2 hover:bg-blue-50 transition-all duration-300">
            <h3 className="text-lg font-semibold text-blue-700 mb-3 text-center">Platform Guidelines</h3>
            <ul className="text-gray-700 text-sm space-y-2">
